...
export const os = (function () {
  if (
    ...
    return "ios";
  else if (navigator.platform === "Win32") return "win64";
  else if (navigator.platform === "MacIntel") return "macos";
  else if (navigator.platform.startsWith("Linux")) return "linux";
  else return "other";
})();
...
export const openWindow =
  ...
  function (instanceId) {
    ...
    if (opened === null) _notify("window-open-failed", { url });
  };
...
export const closeWindow =
  ...
  function () {
    window.close();
    if (!window.closed) window.location = baseUrl;
  };
...
export const showOpenDialog =
  ...
  async function (options) {
    ...
    if (showOpenDialog.cancelPrevious) showOpenDialog.cancelPrevious();
    ...
    let result = await new Promise((resolve, reject) => {
      ...
      showOpenDialog.browser.addEventListener(
        "change",
        function (event) {
...
export const showSaveDialogExternal =
  etron.showSaveDialogExternal || (() => {});
...
export const setDialogProvider =
  etron.setDialogProvider ||
  function (provider) {
    dialogProvider = provider;
  };

export const showSaveDialog =
  etron.showSaveDialog ||
  async function (options) {
